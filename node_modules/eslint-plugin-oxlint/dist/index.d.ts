declare const _default: {
    ...
    buildFromOxlintConfig: (config: import('eslint-plugin-oxlint/dist/build-from-oxlint-config/types.js').OxlintConfig) => import('eslint-plugin-oxlint/dist/build-from-oxlint-config/types.js').EslintPluginOxlintConfig[];
    buildFromOxlintConfigFile: (oxlintConfigFile: string) => import('eslint-plugin-oxlint/dist/build-from-oxlint-config/types.js').EslintPluginOxlintConfig[];
};
